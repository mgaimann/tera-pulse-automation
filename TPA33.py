...
version:    3.3
            ...
            (stable build)
date:       21/09/2017 (updated to Python 3 on 01/03/2021)
...
def waitForUserInput(string):       #function to wait for user enter the correct string to proceed
  while 1:
    ...
    check = str(input("\t\t\t\t\t"))        #get input from user
    #if check == "exit":
    #  break
